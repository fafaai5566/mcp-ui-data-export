  ...
  return (
    ...
    >
      <CheckboxPrimitive.Indicator
        ...
        className="grid place-content-center text-current transition-none data-[state=indeterminate]:[&_.checkbox-check]:hidden data-[state=indeterminate]:[&_.checkbox-minus]:block"
      >
        <CheckIcon className="checkbox-check size-3.5" />
        <Minus className="checkbox-minus size-3.5 hidden" />
      </CheckboxPrimitive.Indicator>
    </CheckboxPrimitive.Root>
  )
}
